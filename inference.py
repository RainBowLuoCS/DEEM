...
from uni_interleaved.utils import (
    ArgumentParser,
    TrainingArguments,
    init_distributed_mode,
    load_model_weights,
)
from uni_interleaved.utils.clip_sim_score import tensor_to_pil
...
def inference_all(model, config, annt_path, output_dir):
    ...
    H = transform.transform1.resolution
