...
class StableDiffusion(nn.Module):
    def __init__(
        ...
        self.unet.requires_grad_(not freeze_dm)
        ...
        def inverted_noise(timestep):
            return torch.round((timestep-500)*0.6+500)
    ...
    def generate_images(
        ...
        for num in range(num_validation_images):
            ...
            seed = num + np.random.randint(100)
    ...
    def forward(
        ...
        with torch.no_grad():
            ...
            if mode=='encoder':
                 timesteps=self.inverted_noise(timesteps)
